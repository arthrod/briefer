...
/**
 * Retrieves a mock user session.
 *
 * This function generates a fixed session object for testing purposes. It returns a session containing hard-coded
 * user details and an empty user workspaces object. This is useful for simulating authenticated user interactions
 * during development and testing scenarios.
 *
 * @returns An object representing a mock user session, with properties for user information and workspaces.
 */
 ...
 *
 * This function extracts the year, month, and day components from the provided Date object.
