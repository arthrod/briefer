...
/**
 * Returns a mock user session for testing purposes.
 *
 * This function generates a dummy session object that contains hardcoded test user data,
 * including user details such as id, status, name, loginName, email, and timestamps for creation and updates.
 * It also provides an empty object for user workspaces, which can be used to simulate user-specific configurations in a test environment.
 *
 * @returns A mock session object with `user` details and an empty `userWorkspaces` object.
 */
 ...
 *
 * This function converts a valid Date object into its string representation, ensuring that both
 * the month and day are zero-padded to maintain a consistent two-digit format.
 *
 * @param date - The Date object to be formatted.
 * @returns A string representing the formatted date as "YYYY-MM-DD".
 */
